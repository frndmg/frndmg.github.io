...
I like to program all kinds of systems, in all kinds of
...
also use stuff like Haskell, Clojure, and the like, but haven't got
...
and internals. This was done using a mix of private cluster and Google
Cloud.
...
store web page.  We had to integrate with the already existing React
codebase.
...
I had to prepare and evaluate multiple projects. Projects involved
ideas like BitTorrent, MapReduce, and Distributed Hash Tables.
